...
const DashboardCard = () => {
  return (
    <div className="max-w-4xl m-auto p-2 mb-5 border dark:border-slate-700">
        ...
        <div className="flex flex-wrap justify-between max-w-4xl m-auto p-2 my-5">
            <div>
                <Link to="/products/10001">
                <img className="w-32 rounded" src="https://images.unsplash.com/photo-1633356122544-f134324a6cee?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=650&q=40" alt="Basics To Advanced In React" />
                </Link>

                <div>
                    <Link to="/products.10002">
                        <p className="text-lg ml-2 dark:text-slate-200">Basics To Advanced In React</p>
                    </Link>  
