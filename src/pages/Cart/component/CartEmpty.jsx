...
const CartEmpty = () => {
  return (
    <section className="text-xl h-screen text-center max-w-4xl mx-auto my-10 py-5 dark:text-slate-100 border dark:border-slate-700 rounded">
        ...
        <Link to="products" type="button" className="text-white bg-blue-700 inline-flex items-center gap-2 hover:bg-blue-800 rounded-lg text-lg px-5 py-2.5 mr-2 dark:hover:bg-blue-700 dark:bg-blue-600 focus:outline-none">
            Continue shopping
            <i className="ml-2"><BiCart/></i>
        </Link>
    </section>
  )
}
